package com.ud.riddle.data.service
...
class GeminiService {
    ...
    suspend fun generateSecretWord(categoria: String): String = withContext(Dispatchers.IO) {
        try {
            Log.d("WORD_DEBUG", "Iniciando petición con categoria: $categoria")
